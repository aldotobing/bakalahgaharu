...
import { Award, Leaf, Globe, Users, Shield, Package, ChevronLeft, ChevronRight } from 'lucide-react';
                    ...
                    >
                      <div className="absolute inset-0 flex items-center justify-center">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            target.onerror = null;
                            target.src = 'https://via.placeholder.com/800x600/f3f4f6/9ca3af?text=Agarwood+Image';
                          }}
                        />
                      </div>
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent p-6 text-white">
                        <div className="text-sm font-medium text-amber-300 mb-1">
                          {agarwoodImages[currentImageIndex].grade[currentLanguage]}
                        </div>
                        <h3 className="font-bold text-xl mb-1">
                          {agarwoodImages[currentImageIndex].title[currentLanguage]}
                        </h3>
                        <p className="text-sm opacity-90">
                          {agarwoodImages[currentImageIndex].description[currentLanguage]}
                        </p>
                      </div>
                    </motion.div>
                  </AnimatePresence>
                    ...
                    {agarwoodImages.map((_, index) => (
                      <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all ${
                          index === currentImageIndex ? 'bg-amber-600 w-6' : 'bg-white/50 w-2'
                        }`}
